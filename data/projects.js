const projects = [
  {
    name: "TOL NFT",
    description:
      "TOL NFT is a project that focuses on creating an efficient tool for tracking hot NFTs. The users will receive real-time updates about transactions and listed NFTs.  so they will never miss out on potentially profitable NFTs",
    pic: "/tolnft.PNG",
